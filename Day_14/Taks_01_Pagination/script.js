...
let pageNumbersElement = document.getElementById("page-numbers");
...
function updatePageNumbers() {
  ...
  pageNumbersElement.appendChild(firstPageLink);
  ...
  pageNumbersElement.appendChild(previousPageLink);
...
function goToPage(page) {
  if (page >= 1 && page <= Math.ceil(array.length / itemsPerPage)) {
    currentPage = page;
    updateContent();
  }
}
