...
// var targetElement = document.getElementById("fname");
...
// maleGenderInput.setAttribute("name", "male");
...
// let fmaleGenderInput = document.createElement("input");
// fmaleGenderInput.setAttribute("type", "radio");
// fmaleGenderInput.setAttribute("name", "male");
// fmaleGenderInput.setAttribute("value", "male");
// let fmaleLabel = document.createElement("label");
// fmaleLabel.textContent = "Female";
// form.appendChild(fmaleLabel);
// form.appendChild(fmaleGenderInput);
// form.appendChild(document.createElement("br"));
// form.appendChild(document.createElement("br"));
...
// // food list1-01
// let foodList1 = document.createElement("input");
// let foodListLabel = document.createElement("label");
// foodList1.setAttribute("type", "checkbox");
// foodListLabel.textContent = "Coconut Chutney";
// form.appendChild(foodList1);
// form.appendChild(foodListLabel);

// // // food checkbox
// // let foodCheckBox = document.createElement("input");
// // foodCheckBox.setAttribute("type", "checkbox");
// // foodCheckBox.setAttribute("value", "Coconut Chutney");
// // form.appendChild(foodCheckBox);
// // // food list label
// // foodList = document.createElement("label");
// // foodList.textContent = "Coconut Chutney";
// // form.appendChild(foodList);
...
// //   foodList.setAttribute("type", "checkbox");
// //   form.appendChild(List);
// //   let checkBoxLabel = document.createElement("label");
// //   checkBoxLabel.textContent = foodList[i];
